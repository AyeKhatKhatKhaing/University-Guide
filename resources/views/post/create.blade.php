            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <button type="submit" form="postForm" class="btn btn-primary feather-plus-circle">Post</button>
                    ...
                    <div class="form-group mt-2 mb-0" >
                        <textarea type="text" name="description" form="postForm"  class="smn form-control mt-2 @error('description') is-invalid @enderror"></textarea>
                        @error('description')
